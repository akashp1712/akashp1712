...
<FlowDiagram
  ...
  nodes={[
    { id: "stay", label: "Stay", sub: "dates & guests", col: 0, accent: true },
    { id: "room", label: "Room", sub: "catalog choice", col: 1 },
    { id: "contact", label: "Contact", sub: "phone + confirm", col: 2 },
    { id: "extras", label: "Extras", sub: "breakfast, notes", col: 3 },
    { id: "waitlist", label: "Waitlist", sub: "NoAvailability", col: 2, accent: true },
    { id: "book", label: "book_room()", sub: "plain function", col: 4, accent: true },
  ]}
  edges={[
    ...
    { from: "stay", to: "waitlist", label: "blocked window" },
  ]}
/>
